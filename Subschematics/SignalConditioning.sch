...
F 2 "Resistor_SMD:R_0805_2012Metric" H 6900 1550 50  0001 C CNN
F 3 "${KIPRJMOD}/Datasheets/AOA0000C301-1488782.pdf" H 6900 1550 50  0001 C CNN
F 4 "https://nl.mouser.com/ProductDetail/Panasonic/ERJ-6GEYJ333V?qs=sGAEpiMZZMtlubZbdhIBIMHu9P6GKOabjkOFRzpgoD0%3D" H 1150 -1650 50  0001 C CNN "Link"
F 5 "Sets LED bias current. Value critical. <5%, AEC-Q200" H 1150 -1650 50  0001 C CNN "Notes"
F 6 "667-ERJ-6GEYJ333V" H 1150 -1650 50  0001 C CNN "Order number"
F 7 "ERJ-6GEYJ333V" H 1150 -1650 50  0001 C CNN "Part number"
F 8 "Mouser" H 1150 -1650 50  0001 C CNN "Supplier"
	1    6900 1550
	0    -1   1    0   
$EndComp
$Comp
...
Wire Bus Line
	9300 2850 9200 2800
Text Notes 8975 2775 2    50   ~ 0
Current
Text Notes 8700 2650 0    50   ~ 0
Finger probe
Wire Notes Line
	10000 2550 10000 4150
Wire Notes Line
	10000 4150 8650 4150
Wire Notes Line
	8650 2550 10000 2550
Wire Notes Line
	8650 4150 8650 2550
Wire Bus Line
...
Change finger probe to common ground, have constant current source \nthrough LEDs which is short-circuited by microcontroller. This ensures a \nconstant current flow, thus not inducing an 80Hz component in the supply \nthrough the 10Ω polyfuse.
$Comp
L Device:R_US R?
U 1 1 5EF9D901
P 6000 2700
...
AR Path="/5EBC342A/5EF9D901" Ref="R?"  Part="1" 
F 0 "R?" H 6100 2650 50  0000 L CNN
F 1 "47Ω" H 6100 2750 50  0000 L CNN
F 2 "POxiM-uncategorised:R_0805_2012Metric_0603_1608Metric" H 6000 2700 50  0001 C CNN
F 3 "" H 6000 2700 50  0001 C CNN
F 4 "" H 250 -1100 50  0001 C CNN "Link"
F 5 "" H 250 -1100 50  0001 C CNN "Notes"
F 6 "" H 250 -1100 50  0001 C CNN "Order number"
F 7 "" H 250 -1100 50  0001 C CNN "Part number"
F 8 "" H 250 -1100 50  0001 C CNN "Supplier"
	1    6000 2700
	1    0    0    1   
$EndComp
...
AR Path="/5EBC342A/5EFB4A00" Ref="Q?"  Part="1" 
F 0 "Q?" H 6090 3146 50  0000 L CNN
...
AR Path="/5EBC342A/5F00667D" Ref="C?"  Part="1" 
F 0 "C?" H 6700 3650 50  0000 R CNN
F 1 "100nF" H 6700 3550 50  0000 R CNN
F 2 "Capacitor_SMD:C_0805_2012Metric" H 6800 3600 50  0001 C CNN
F 3 "${KIPRJMOD}/Datasheets/GCD21BR72A104KA01-01-1668138.pdf" H 6800 3600 50  0001 C CNN
F 4 "Decoupling capacitance. Value non-critical. X7R, >10V, AEC-Q200." H 850 -1050 50  0001 C CNN "Notes"
F 5 "https://nl.mouser.com/ProductDetail/Murata-Electronics/GCD21BR72A104KA01L?qs=QzBtWTOodeUgjSVpOGt6MA%3D%3D" H 850 -1050 50  0001 C CNN "Link"
F 6 "81-GCD21BR72A104KA1L" H 850 -1050 50  0001 C CNN "Order number"
F 7 "GCD21BR72A104KA01L" H 850 -1050 50  0001 C CNN "Part number"
F 8 "Mouser" H 850 -1050 50  0001 C CNN "Supplier"
	1    6800 3600
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 5F006688
P 6800 3150
F 0 "R?" H 6850 3100 50  0000 L CNN
F 1 "33kΩ" H 6850 3200 50  0000 L CNN
F 2 "Resistor_SMD:R_0805_2012Metric" H 6800 3150 50  0001 C CNN
F 3 "${KIPRJMOD}/Datasheets/AOA0000C301-1488782.pdf" H 6800 3150 50  0001 C CNN
F 4 "https://nl.mouser.com/ProductDetail/Panasonic/ERJ-6GEYJ333V?qs=sGAEpiMZZMtlubZbdhIBIMHu9P6GKOabjkOFRzpgoD0%3D" H 650 -1500 50  0001 C CNN "Link"
F 5 "Sets LED bias current. Value critical. <5%, AEC-Q200" H 650 -1500 50  0001 C CNN "Notes"
F 6 "667-ERJ-6GEYJ333V" H 650 -1500 50  0001 C CNN "Order number"
F 7 "ERJ-6GEYJ333V" H 650 -1500 50  0001 C CNN "Part number"
F 8 "Mouser" H 650 -1500 50  0001 C CNN "Supplier"
	1    6800 3150
	1    0    0    1   
$EndComp
...
AR Path="/5EBC342A/5F033FBE" Ref="D?"  Part="1" 
F 0 "D?" H 6400 3500 50  0000 C CNN
...
Assume supply voltage fluctuation should be 100dB down (equal to standard \npower supply noise). Then the current should vary:\nΔV / Vs = -100dB\nΔV = ΔI · Rmax\nΔI = -100dB · Vs / Rmax = 0.05mV / 1Ω = 50µA\nΔI / Imax = 50µA / 1mA = 5%
$Comp
...
AR Path="/5EBC342A/5F6BB73D" Ref="TP?"  Part="1" 
F 0 "TP?" H 7258 1568 50  0000 L CNN
...
Connection ~ 9430 3310
Connection ~ 9430 3910
Connection ~ 9380 3310
Connection ~ 9380 3910
...
Wire Bus Line
	9300 4000 9300 3950
Connection ~ 9270 2730
Connection ~ 9220 2730
...
AR Path="/5EBC342A/5F78D93A" Ref="D?"  Part="1" 
F 0 "D?" V 6450 1800 50  0000 L CNN
...
AR Path="/5EBC342A/5F7D3AD8" Ref="TP?"  Part="1" 
F 0 "TP?" H 7258 3418 50  0000 L CNN
...
AR Path="/5EBC342A/5F807DA2" Ref="TP?"  Part="1" 
F 0 "TP?" H 7258 4968 50  0000 L CNN
...
AR Path="/5EBC342A/5F8AB20F" Ref="R?"  Part="1" 
F 0 "R?" H 5600 3250 50  0000 R CNN
...
F 4 "https://nl.mouser.com/ProductDetail/Panasonic/ERJ-6ENF3301V?qs=sGAEpiMZZMtlubZbdhIBIGigBIB3A6R9dIvMOtC7jmQ%3D" H 0   -2650 50  0001 C CNN "Link"
F 5 "Sets transistor base current. Value critical. <5%, AEC-Q200" H 0   -2650 50  0001 C CNN "Notes"
F 6 "667-ERJ-6ENF3301V" H 0   -2650 50  0001 C CNN "Order number"
F 7 "ERJ-6ENF3301V" H 0   -2650 50  0001 C CNN "Part number"
F 8 "Mouser" H 0   -2650 50  0001 C CNN "Supplier"
	1    5650 3300
	1    0    0    1   
$EndComp
Wire Bus Line
...
AR Path="/5EBC342A/5F8BD89F" Ref="R?"  Part="1" 
F 0 "R?" H 5600 2850 50  0000 R CNN
F 1 "820Ω" H 5600 2950 50  0000 R CNN
F 2 "POxiM-uncategorised:R_0805_2012Metric_0603_1608Metric" H 5650 2900 50  0001 C CNN
F 3 "" H 5650 2900 50  0001 C CNN
F 4 "" H 0   -3050 50  0001 C CNN "Link"
F 5 "" H 0   -3050 50  0001 C CNN "Notes"
F 6 "" H 0   -3050 50  0001 C CNN "Order number"
F 7 "" H 0   -3050 50  0001 C CNN "Part number"
F 8 "" H 0   -3050 50  0001 C CNN "Supplier"
	1    5650 2900
	1    0    0    1   
$EndComp
Wire Notes Line
...
AR Path="/5EBC342A/5F93FF9F" Ref="D?"  Part="1" 
F 0 "D?" V 6000 3550 50  0000 R CNN
...
AR Path="/5EBC342A/5F95DC77" Ref="R?"  Part="1" 
F 0 "R?" H 6100 4200 50  0000 L CNN
F 1 "47Ω" H 6100 4300 50  0000 L CNN
F 2 "POxiM-uncategorised:R_0805_2012Metric_0603_1608Metric" H 6000 4250 50  0001 C CNN
F 3 "" H 6000 4250 50  0001 C CNN
F 4 "" H 250 450 50  0001 C CNN "Link"
F 5 "" H 250 450 50  0001 C CNN "Notes"
F 6 "" H 250 450 50  0001 C CNN "Order number"
F 7 "" H 250 450 50  0001 C CNN "Part number"
F 8 "" H 250 450 50  0001 C CNN "Supplier"
	1    6000 4250
	1    0    0    1   
$EndComp
...
AR Path="/5EBC342A/5F95DC87" Ref="Q?"  Part="1" 
F 0 "Q?" H 6090 4696 50  0000 L CNN
...
AR Path="/5EBC342A/5F95DC9A" Ref="C?"  Part="1" 
F 0 "C?" H 6700 5250 50  0000 R CNN
F 1 "100nF" H 6700 5150 50  0000 R CNN
F 2 "Capacitor_SMD:C_0805_2012Metric" H 6800 5200 50  0001 C CNN
F 3 "${KIPRJMOD}/Datasheets/GCD21BR72A104KA01-01-1668138.pdf" H 6800 5200 50  0001 C CNN
F 4 "Decoupling capacitance. Value non-critical. X7R, >10V, AEC-Q200." H 850 550 50  0001 C CNN "Notes"
F 5 "https://nl.mouser.com/ProductDetail/Murata-Electronics/GCD21BR72A104KA01L?qs=QzBtWTOodeUgjSVpOGt6MA%3D%3D" H 850 550 50  0001 C CNN "Link"
F 6 "81-GCD21BR72A104KA1L" H 850 550 50  0001 C CNN "Order number"
F 7 "GCD21BR72A104KA01L" H 850 550 50  0001 C CNN "Part number"
F 8 "Mouser" H 850 550 50  0001 C CNN "Supplier"
	1    6800 5200
	1    0    0    -1  
$EndComp
$Comp
...
F 2 "Resistor_SMD:R_0805_2012Metric" H 6800 4700 50  0001 C CNN
F 3 "${KIPRJMOD}/Datasheets/AOA0000C301-1488782.pdf" H 6800 4700 50  0001 C CNN
F 4 "https://nl.mouser.com/ProductDetail/Panasonic/ERJ-6GEYJ333V?qs=sGAEpiMZZMtlubZbdhIBIMHu9P6GKOabjkOFRzpgoD0%3D" H 650 50  50  0001 C CNN "Link"
F 5 "Sets LED bias current. Value critical. <5%, AEC-Q200" H 650 50  50  0001 C CNN "Notes"
F 6 "667-ERJ-6GEYJ333V" H 650 50  50  0001 C CNN "Order number"
F 7 "ERJ-6GEYJ333V" H 650 50  50  0001 C CNN "Part number"
F 8 "Mouser" H 650 50  50  0001 C CNN "Supplier"
	1    6800 4700
	1    0    0    1   
$EndComp
...
AR Path="/5EBC342A/5F95DCB7" Ref="D?"  Part="1" 
F 0 "D?" H 6400 5050 50  0000 C CNN
...
AR Path="/5EBC342A/5F95DCD5" Ref="R?"  Part="1" 
F 0 "R?" H 5600 4800 50  0000 R CNN
F 1 "3.3kΩ" H 5600 4900 50  0000 R CNN
F 2 "Resistor_SMD:R_0805_2012Metric" H 5650 4850 50  0001 C CNN
F 3 "${KIPRJMOD}/Datasheets/AOA0000C304-1149620.pdf" H 5650 4850 50  0001 C CNN
F 4 "https://nl.mouser.com/ProductDetail/Panasonic/ERJ-6ENF3301V?qs=sGAEpiMZZMtlubZbdhIBIGigBIB3A6R9dIvMOtC7jmQ%3D" H 0   -1100 50  0001 C CNN "Link"
F 5 "Sets transistor base current. Value critical. <5%, AEC-Q200" H 0   -1100 50  0001 C CNN "Notes"
F 6 "667-ERJ-6ENF3301V" H 0   -1100 50  0001 C CNN "Order number"
F 7 "ERJ-6ENF3301V" H 0   -1100 50  0001 C CNN "Part number"
F 8 "Mouser" H 0   -1100 50  0001 C CNN "Supplier"
	1    5650 4850
	1    0    0    1   
$EndComp
$Comp
...
AR Path="/5EBC342A/5F95DCE0" Ref="R?"  Part="1" 
F 0 "R?" H 5600 4400 50  0000 R CNN
F 1 "820Ω" H 5600 4500 50  0000 R CNN
F 2 "POxiM-uncategorised:R_0805_2012Metric_0603_1608Metric" H 5650 4450 50  0001 C CNN
F 3 "" H 5650 4450 50  0001 C CNN
F 4 "" H 0   -1500 50  0001 C CNN "Link"
F 5 "" H 0   -1500 50  0001 C CNN "Notes"
F 6 "" H 0   -1500 50  0001 C CNN "Order number"
F 7 "" H 0   -1500 50  0001 C CNN "Part number"
F 8 "" H 0   -1500 50  0001 C CNN "Supplier"
	1    5650 4450
	1    0    0    1   
$EndComp
Wire Notes Line
...
AR Path="/5EBC342A/5F95DCF2" Ref="D?"  Part="1" 
F 0 "D?" V 6000 5100 50  0000 R CNN
