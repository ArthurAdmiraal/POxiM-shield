...
F 1 "500mA" V 2516 3100 50  0000 C CNN
F 2 "Resistor_SMD:R_1812_4532Metric" H 2700 2900 50  0001 L CNN
F 3 "${KIPRJMOD}/Datasheets/0ZCG_Nov2016-1132141.pdf" H 2650 3100 50  0001 C CNN
F 4 "530-0ZCG0050FF2C" H -2350 -150 50  0001 C CNN "Order number"
F 5 "0ZCG0050FF2C " H -2350 -150 50  0001 C CNN "Part number"
F 6 "Mouser" H -2350 -150 50  0001 C CNN "Supplier"
F 7 "https://nl.mouser.com/ProductDetail/Bel-Fuse/0ZCG0050FF2C?qs=sGAEpiMZZMsgjL4JkW1EEcd%252Bb5fzYQwTN3%252BBvCLJLX%252B5PWZvY0sqIg%3D%3D" H -2350 -150 50  0001 C CNN "Link"
F 8 "Used for under- and overvoltage protection and overcurrent protection." H -1250 0   50  0001 C CNN "Notes"
	1    2650 3100
	0    1    1    0   
$EndComp
$Comp
...
U 1 1 5EBC8E0D
P 3050 3600
F 0 "D34" V 3004 3680 50  0000 L CNN
F 1 "6.8V" V 3095 3680 50  0000 L CNN
F 2 "POxiM-uncategorised:D_SOD-123" H 3050 3600 50  0001 C CNN
F 3 "${KIPRJMOD}/Datasheets/vishay_mmsz52251-1211520.pdf" H 3050 3600 50  0001 C CNN
F 4 "78-MMSZ5235C-E3-08" H -2650 -150 50  0001 C CNN "Order number"
F 5 "MMSZ5235C-E3-08" H -2650 -150 50  0001 C CNN "Part number"
F 6 "Mouser" H -2650 -150 50  0001 C CNN "Supplier"
F 7 "https://nl.mouser.com/ProductDetail/Vishay-Semiconductors/MMSZ5235C-E3-08?qs=%2Fha2pyFadujV4RO4S1waElb5dV%252B%252B64uy%252BMxGR3Uu3OLRSQj%252BNF3A9w6RObocYX7m" H -2650 -150 50  0001 C CNN "Link"
F 8 "Used for overvoltage protection. Ensure leakage current is <0.1mA at 5.5V." H -2650 -150 50  0001 C CNN "Notes"
	1    3050 3600
	0    1    1    0   
$EndComp
Wire Wire Line
...
F 0 "D35" V 3400 3680 50  0000 L CNN
F 1 "Schottky" V 3445 3680 50  0001 L CNN
F 2 "POxiM-uncategorised:D_SOD-323" H 3400 3600 50  0001 C CNN
F 3 "${KIPRJMOD}/Datasheets/Infineon-BAS3010ASERIES-DS-v01_01-en-1226012.pdf" H 3400 3600 50  0001 C CNN
F 4 "726-BAS3010A03WE632" H -2800 -150 50  0001 C CNN "Order number"
F 5 "BAS3010A03WE6327XT" H -2800 -150 50  0001 C CNN "Part number"
F 6 "Mouser" H -2800 -150 50  0001 C CNN "Supplier"
F 7 "Used for reverse polarity protection, forward voltage should be lower than µC ESD protection Vf." H -2800 -150 50  0001 C CNN "Notes"
F 8 "https://nl.mouser.com/ProductDetail/Infineon-Technologies/BAS3010A03WE6327XT?qs=6QXTaorEuHthvzrroBEBiQ%3D%3D" H -2800 -150 50  0001 C CNN "Link"
	1    3400 3600
	0    1    1    0   
$EndComp
Wire Notes Line
...
U 1 1 5EC5B0EB
P 2300 4400
F 0 "JP2" H 2300 4650 50  0000 C CNN
F 1 "UART out jumper" H 2300 4550 50  0000 C CNN
F 2 "POxiM-uncategorised:R_0805_2012Metric_0603_1608Metric" H 2300 4400 50  0001 C CNN
F 3 "${KIPRJMOD}/Datasheets/AOA0000C301-1488782.pdf" H 2300 4400 50  0001 C CNN
F 4 "ERJ-3GEYJ561V" H 2300 4400 50  0001 C CNN "Part number"
F 5 "667-ERJ-3GEYJ561V" H 2300 4400 50  0001 C CNN "Order number"
F 6 "Mouser" H 2300 4400 50  0001 C CNN "Supplier"
F 7 "https://nl.mouser.com/ProductDetail/Panasonic/ERJ-3GEYJ561V?qs=sGAEpiMZZMtlubZbdhIBIDkNbKahCB4%252B6KNOdheeNIE%3D" H 2300 4400 50  0001 C CNN "Link"
F 8 "DNP, used only for debugging" H -2350 -100 50  0001 C CNN "Notes"
	1    2300 4400
	1    0    0    1   
$EndComp
...
F 0 "TP1" H 1708 3168 50  0000 L CNN
F 1 "5V in" H 1708 3077 50  0000 L CNN
F 2 "POxiM-uncategorised:TestPoint_THTPad_D1.0mm_Drill0.5mm" H 1850 3050 50  0001 C CNN
F 3 "~" H 1850 3050 50  0001 C CNN
F 4 "~" H -1250 0   50  0001 C CNN "Link"
F 5 "SHOULD NOT BE ON BOM" H -1250 0   50  0001 C CNN "Notes"
F 6 "~" H -1250 0   50  0001 C CNN "Order number"
F 7 "~" H -1250 0   50  0001 C CNN "Part number"
F 8 "~" H -1250 0   50  0001 C CNN "Supplier"
	1    1650 3050
	1    0    0    -1  
$EndComp
Wire Wire Line
...
U 1 1 5EBDE477
P 2300 4000
F 0 "JP1" H 2300 4235 50  0000 C CNN
F 1 "SWIM jumper" H 2300 4144 50  0000 C CNN
F 2 "POxiM-uncategorised:R_0805_2012Metric_0603_1608Metric" H 2300 4000 50  0001 C CNN
F 3 "${KIPRJMOD}/Datasheets/AOA0000C301-1488782.pdf" H 2300 4000 50  0001 C CNN
F 4 "ERJ-3GEYJ561V" H 2300 4000 50  0001 C CNN "Part number"
F 5 "667-ERJ-3GEYJ561V" H 2300 4000 50  0001 C CNN "Order number"
F 6 "Mouser" H 2300 4000 50  0001 C CNN "Supplier"
F 7 "https://nl.mouser.com/ProductDetail/Panasonic/ERJ-3GEYJ561V?qs=sGAEpiMZZMtlubZbdhIBIDkNbKahCB4%252B6KNOdheeNIE%3D" H 2300 4000 50  0001 C CNN "Link"
F 8 "DNP, used only for debugging" H -2350 -150 50  0001 C CNN "Notes"
	1    2300 4000
	1    0    0    -1  
$EndComp
Text Notes 2200 4050 0    50   ~ 10
DNP
...
U 1 1 5F15D270
P 4050 3800
AR Path="/5EBC562E/5F15D270" Ref="R?"  Part="1" 
AR Path="/5EBC558F/5F15D270" Ref="R?"  Part="1" 
AR Path="/5EBC342A/5F15D270" Ref="R?"  Part="1" 
AR Path="/5EBC5C8E/5F15D270" Ref="R?"  Part="1" 
F 0 "R?" H 3975 3850 50  0000 R CNN
F 1 "560Ω" H 3975 3750 50  0000 R CNN
F 2 "POxiM-uncategorised:R_0805_2012Metric_0603_1608Metric" H 4050 3800 50  0001 C CNN
F 3 "${KIPRJMOD}/Datasheets/AOA0000C301-1488782.pdf" H 4050 3800 50  0001 C CNN
F 4 "https://nl.mouser.com/ProductDetail/Panasonic/ERJ-3GEYJ561V?qs=sGAEpiMZZMtlubZbdhIBIDkNbKahCB4%252B6KNOdheeNIE%3D" H 1800 -300 50  0001 C CNN "Link"
F 5 "Sets display LED current. Value critical. <5%, AEC-Q200" H 1800 -300 50  0001 C CNN "Notes"
F 6 "667-ERJ-3GEYJ561V" H 1800 -300 50  0001 C CNN "Order number"
F 7 "ERJ-3GEYJ561V" H 1800 -300 50  0001 C CNN "Part number"
F 8 "Mouser" H 1800 -300 50  0001 C CNN "Supplier"
	1    4050 3800
	1    0    0    -1  
$EndComp
Wire Wire Line
